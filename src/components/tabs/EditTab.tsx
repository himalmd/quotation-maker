    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid gap-8">
      ...
      <section className={sectionClass}>
        ...
        <textarea
          ...
          rows={6}
          className="w-full rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-100 px-4 py-3 text-sm focus:border-blue-500 focus:outline-none resize-y"
